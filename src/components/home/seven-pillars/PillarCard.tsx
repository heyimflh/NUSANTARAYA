...
export function PillarCard({
  ...
  const absActiveOffset = Math.abs(activeOffset);
  ...
  return (
    <motion.div
      className="absolute top-1/2 left-1/2 cursor-pointer origin-center rounded-[32px] overflow-hidden bg-[#F8F4EA]"
      style={{
        width: "380px",
        height: "560px",
        marginTop: "-280px",
    ...
    >
      {/* Background Image: Kept bright and clear. No extreme darkening! */}
      <motion.div
      ...
      {/* Subtle, elegant gradient JUST at the bottom for text legibility. No full-card dark overlays. */}
      <motion.div 
      ...
      <div className="absolute inset-0 p-8 flex flex-col justify-end text-white">
        ...
        >
          ...
          <div className="flex items-center gap-4 mb-4">
            {/* Pure Logo (Always Visible, No Container) */}
            <motion.div 
          ...
          {/* Title is explicitly white and crisp with strong halo shadow */}
          <h3 
