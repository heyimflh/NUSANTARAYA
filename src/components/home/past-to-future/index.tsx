...
const phases = [
  {
    ...
    description: "NUSANTARAYA mengarsipkan sejarah, aksara, tradisi, cerita rakyat, rumah adat, jalur rempah, dan simbol budaya dari berbagai provinsi Indonesia.",
  ...
  },
  {
    ...
    description: "Budaya tidak hanya dibaca, tetapi dialami melalui destinasi wisata, kuliner, festival, desa wisata, UMKM, dan cerita lokal yang hidup hari ini.",
  ...
  },
  {
    ...
    description: "NUSANTARAYA memperlihatkan bagaimana identitas daerah terhubung dengan IKN, smart city, UMKM digital, ekonomi kreatif, green tourism, dan desa wisata digital.",
...
export function PastToFutureSection() {
  return (
    <section className="relative w-full overflow-hidden font-sans pt-[72px] pb-[72px] md:pt-[120px] md:pb-[120px]"
      style={{
        background: `
          radial-gradient(circle at 15% 20%, rgba(201, 168, 76, 0.16), transparent 34%),
          radial-gradient(circle at 85% 80%, rgba(45, 107, 228, 0.12), transparent 36%),
          linear-gradient(135deg, #F8F4EA 0%, #FFFDF8 48%, #EDF4FF 100%)
        `
      }}
    >
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-4 md:px-8">
        ...
        <div className="flex flex-col items-center text-center max-w-[760px] mx-auto mb-16 md:mb-24">
          ...
          >
            Dari Warisan Budaya<br className="hidden md:block" /> ke Masa Depan Digital
          </motion.h2>
          ...
          >
            NUSANTARAYA menghubungkan sejarah, tradisi, wisata, kuliner, UMKM, dan kota digital dalam satu cerita besar Indonesia: dari masa lalu yang kaya menuju masa depan yang sedang dibangun.
          </motion.p>
        ...
        <div className="relative w-full">
          ...
          <div className="hidden md:block absolute top-[36px] left-[16.66%] right-[16.66%] h-[2px] z-0 overflow-hidden rounded-full">
            ...
            <div 
              ...
              style={{
                backgroundImage: 'linear-gradient(to right, #0D1B2A 50%, transparent 50%)',
            ...
            <motion.div 
              ...
              style={{
                background: 'linear-gradient(90deg, transparent, rgba(201,168,76,0.5), rgba(45,90,39,0.5), rgba(45,107,228,0.5), transparent)',
              }}
              animate={{ left: ["-40%", "100%"] }}
              transition={{ duration: 6, ease: "easeInOut", repeat: Infinity, repeatDelay: 0.5 }}
            />
          </div>
                ...
                <div className="hidden md:flex flex-col items-center mb-10 relative z-10 group cursor-default">
                  <div className="relative w-[72px] h-[72px]">
                    ...
                    <div 
                      ...
                      style={{ boxShadow: `0 8px 32px -8px ${phase.accentColor}60` }}
                    >
                      ...
                      />
                      <span className="font-serif text-[26px] font-bold" style={{ color: phase.accentColor }}>
                        {phase.id}
                      </span>
                    </div>
                  </div>
                ...
                <div className="bg-white/80 backdrop-blur-md border border-[#C9A84C]/20 rounded-[28px] md:rounded-[32px] overflow-hidden shadow-lg transition-transform duration-500 hover:-translate-y-2 flex-1 flex flex-col group relative">
                  ...
                  <div className="p-6 md:p-8 flex-1 flex flex-col relative z-10">
                    ...
                    {phase.bgDecor && (
                      <div 
                        ...
                        style={{ backgroundImage: `url('${phase.bgDecor}')`, backgroundSize: 'cover', backgroundPosition: 'center' }}
                      />
                    )}
                    ...
                    <div className="flex items-center gap-3 mb-4 md:hidden relative z-10">
                      <div 
                        ...
                        style={{ boxShadow: `0 4px 12px -4px ${phase.accentColor}60` }}
                      >
                        <span className="font-serif text-sm font-bold" style={{ color: phase.accentColor }}>{phase.id}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <img src={phase.icon} className="w-5 h-5 object-contain" alt="" />
                        <span className="text-[11px] font-bold tracking-widest uppercase" style={{ color: phase.accentColor }}>
                          {phase.label}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="hidden md:flex items-center gap-3 mb-4 relative z-10">
                      <img src={phase.icon} className="w-[22px] h-[22px] object-contain" alt="" />
                      <span className="text-[12px] font-bold tracking-widest uppercase" style={{ color: phase.accentColor }}>
                        {phase.label}
                      </span>
                    </div>
                  ...
                  <div className="w-full h-[220px] md:h-[260px] relative overflow-hidden bg-[#F8F4EA]">
                    ...
                    <div 
                      ...
                      style={{ background: `linear-gradient(to top, ${phase.accentLight}, transparent)` }}
                    />
                  </div>
                </div>
              </motion.div>
        ...
        >
          <p className="font-serif italic text-xl md:text-3xl text-[#0D1B2A] max-w-[800px] mx-auto leading-relaxed px-4">
            "Warisan menjadi akar. Teknologi menjadi jembatan. Nusantara menjadi pengalaman."
          </p>
        </motion.div>
      </div>
    </section>
