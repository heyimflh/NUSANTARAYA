...
export const PassportHeroSection = () => {
  return (
    <section className="relative w-full h-screen min-h-[750px] flex items-center overflow-hidden [--wave-h:80px] md:[--wave-h:120px] lg:[--wave-h:160px]">
        ...
        >
          ...
          >
            <source
              src="/assets/background/background-passport.webm"
              type="video/webm"
            />
          </video>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-20 h-full flex flex-col justify-center">
          <div className="max-w-[500px] mt-12 lg:mt-16">
            ...
            >
              Simpan jejak petualangan, kumpulkan cap destinasi, dan jadikan setiap rute sebagai kenangan digital yang tak terlupakan di seluruh Nusantara.
            </motion.p>
            ...
            >
              <a
                ...
                onClick={(e) => {
                  e.preventDefault();
                  document.getElementById("passport-content")?.scrollIntoView({ behavior: "smooth" });
                }}
        ...
        <div className="absolute bottom-0 left-0 w-full z-20 pointer-events-none h-[80px] md:h-[120px] lg:h-[160px]">
          ...
          <motion.div
            ...
            onClick={() => document.getElementById("passport-content")?.scrollIntoView({ behavior: "smooth" })}
          >
