            ...
            <div className="px-6 pb-8 md:px-10 md:pb-10 pt-2 flex flex-col">
              ...
              <div className="flex flex-wrap items-center gap-4 mt-12 ml-4 md:ml-[116px] pt-8 border-t border-[#E8E0CE]/50">
                ...
                {day.provinceIds[0] && (
                  <button
                    type="button"
                    onClick={() => handleOpenAtlas(day.provinceIds[0])}
                    className="flex items-center gap-2 px-6 py-3 min-h-11 rounded-full bg-white border border-[#E8E0CE] text-[#5C6470] font-bold text-[14px] hover:bg-[#F8F4EA] hover:border-[#D9CDBC] hover:text-[#0D1B2A] transition-all focus-visible:outline-2 focus-visible:outline-[#C9A84C] focus-visible:outline-offset-2"
                  >
                ...
                <button
                  type="button"
                  onClick={() => navigateToRouteSection("saveRani")}
                  className="flex items-center gap-2 px-6 py-3 min-h-11 rounded-full bg-white border border-[#E8E0CE] text-[#5C6470] font-bold text-[14px] hover:bg-[#F8F4EA] hover:border-[#D9CDBC] hover:text-[#0D1B2A] transition-all focus-visible:outline-2 focus-visible:outline-[#C9A84C] focus-visible:outline-offset-2"
                >
