...
import { featuredProvinces, type MapLayerId } from "@/data/preview-map";
    ...
    <>
          ...
          <div className="flex flex-col lg:flex-row gap-8 md:gap-12 lg:gap-8 items-center lg:items-start">
            ...
            <div className="w-full lg:w-[45%] flex flex-col justify-center pt-2 md:pt-4 lg:pt-12">
              ...
              <h2 className="font-serif text-[2.25rem] leading-[1.15] sm:text-4xl md:text-5xl lg:text-[4.2rem] lg:leading-[1.05] text-[#10233F] tracking-tight mb-6 md:mb-8">
                Singkap{" "}
                <span className="italic font-light text-[#D8B56D]">
                  Magisnya
                </span>{" "}
                Nusantara dari Satu Peta.
              </h2>
              ...
              <div className="pl-4 md:pl-6 border-l border-[#D8B56D]/30 mb-8 md:mb-10">
                <p className="text-[#10233F]/75 text-base md:text-[1.1rem] leading-[1.8] max-w-[40ch] font-medium">
                  Setiap titik di peta menyimpan cerita unik—merangkai rasa,
                  tradisi, alam, aksara, hingga visi masa depan digital
                  Nusantara.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-5 sm:gap-7 mb-8 md:mb-16">
                ...
                <button className="group relative text-[#10233F] text-xs font-bold tracking-[0.1em] uppercase transition-all duration-300 flex items-center gap-2 pb-1.5">
                  Lihat Unggulan
                  <svg
                    className="w-4 h-4 transform transition-transform duration-500 ease-out group-hover:translate-x-1.5"
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="2"
      ...
      <section className="bg-[#F8F4EA] bg-[url('/assets/background-primary.png')] max-md:bg-[url('/assets/background-primary-mobile.png')] bg-cover bg-center bg-fixed bg-no-repeat relative pt-16 pb-12 md:pt-20 md:pb-16 overflow-hidden -mt-6 md:-mt-10 rounded-t-[2.5rem] md:rounded-t-[3.5rem] shadow-[0_-20px_40px_rgba(0,0,0,0.15)] z-30">
        ...
        <div 
          ...
          style={{ backgroundImage: `url('/assets/branding/ornamen-batik.svg')`, backgroundSize: '520px', backgroundPosition: 'bottom center' }}
        />
        ...
        <div className="container mx-auto max-w-7xl px-4 md:px-8 relative z-20">
          ...
          <div className="flex flex-col items-center mb-10 md:mb-14">
            ...
            <h3 className="font-serif text-xl md:text-2xl lg:text-3xl text-[#10233F] text-center max-w-2xl leading-relaxed">
              Menyatukan{" "}
              <span className="italic font-light text-[#D8B56D]">kekayaan</span>{" "}
              Nusantara dalam satu jendela{" "}
